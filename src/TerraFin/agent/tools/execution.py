"""Tool execution engine — wraps the hosted tool adapter, builds tool-result
messages, and surfaces loop-guard outcomes."""
import json
...
from .types import TerraFinToolInvocationResult
